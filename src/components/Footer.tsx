        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            ...
            <p style={{
              ...
              Pakistan&apos;s premier destination for PC, Laptops & Gaming hardware. Leaders in Wholesale & Retail since 2010 with a dedicated physical presence in Saddar, Karachi. Genuine products, competitive prices, delivered fast.
            </p>
            ...
            >
              ...
              <span>RETAIL: ORDER VIA WHATSAPP</span>
            </a>
